...
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}       phoenix-dots setup     ${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""

if [ "$NO_CONFIRM" = false ]; then
    echo -e "${NC}Welcome to the phoenix-dots setup script!${NC}"
    echo -e "${NC}This script will install phoenix-dots on your system.${NC}"
    echo ""
fi
...
if [ $? -eq 0 ]; then
    ...
    echo -e "${BLUE}Please star this project on GitHub: ${NC}https://github.com/Better-Than-You/phoenix-dots"
    echo -e "${BLUE}And report any issues: ${NC}https://github.com/Better-Than-You/phoenix-dots/issues"
    echo ""
else
