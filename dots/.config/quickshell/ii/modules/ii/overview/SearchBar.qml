...
RowLayout {
    ...
    property var searchPrefixType: {
        ...
        if (root.searchingText.startsWith(Config.options.search.prefix.fileSearch)) return SearchBar.SearchPrefixType.FileSearch;
    ...
    MaterialShapeWrappedMaterialSymbol {
        ...
        shape: switch(root.searchPrefixType) {
            ...
            case SearchBar.SearchPrefixType.FileSearch: return MaterialShape.Shape.Pill;
        ...
        text: switch (root.searchPrefixType) {
            ...
            case SearchBar.SearchPrefixType.FileSearch: return "file_open";
